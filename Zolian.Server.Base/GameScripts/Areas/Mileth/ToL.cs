...
public class ToL : AreaScript
{
    ...
    private void HandleMapAnimations(TimeSpan elapsedTime)
    {
        ...
        if (a)
        {
            ...
            _playersOnMap.Values.FirstOrDefault()?.SendAnimationNearby(192, new Position(21, 40));
            _playersOnMap.Values.FirstOrDefault()?.SendAnimationNearby(192, new Position(14, 40));
        }
