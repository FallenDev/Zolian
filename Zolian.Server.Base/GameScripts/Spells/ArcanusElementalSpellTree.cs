...
public class Mor_Strioch_Pian_Gar : SpellScript
{
    ...
    public override void OnSuccess(Sprite sprite, Sprite target)
    {
        ...
        foreach (var targetObj in targets)
        {
            ...
            var dmg = aisling.MaximumMp * 0.01 * (aisling.Int * 0.01) * 200;
            aisling.Cast(_spell, target);
            targetObj.ApplyElementalSpellDamage(aisling, (int)dmg, aisling.OffenseElement, _spell);
        }
    ...
    public override void OnUse(Sprite sprite, Sprite target)
    {
        ...
        aisling.CurrentMp = (int)(aisling.MaximumMp / .33);
        aisling.CurrentHp = (int)(aisling.MaximumHp / .33);
