...
[Script("Gift Wrapping Heart")]
public class GiftWrappingHeart(WorldServer server, Mundane mundane) : MundaneScript(server, mundane)
{
            ...
            case 0x00:
                {
                    ...
                    itemFromSlot.GiftWrapped = "Heart";
                    itemFromSlot.DisplayImage = 2300;
