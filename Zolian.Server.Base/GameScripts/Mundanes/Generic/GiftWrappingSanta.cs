...
[Script("Gift Wrapping Santa")]
public class GiftWrappingSanta(WorldServer server, Mundane mundane) : MundaneScript(server, mundane)
{
            ...
            case 0x00:
                {
                    ...
                    itemFromSlot.GiftWrapped = "Santa";
                    itemFromSlot.DisplayImage = 2302;
