            ...
            case 0x11:
                {
                    ...
                    Task.Delay(350).ContinueWith(ct => { client.Aisling.SendAnimationNearby(303, null, client.Aisling.Serial); });
                    Task.Delay(350).ContinueWith(ct => { client.Aisling.SendTargetedClientMethod(PlayerScope.NearbyAislings, c => c.SendSound(97, false)); });
                    Task.Delay(750).ContinueWith(ct => { client.Aisling.SendAnimationNearby(303, null, client.Aisling.Serial); });
                    client.CloseDialog();
