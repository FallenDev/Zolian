            ...
            case 0x09:
                {
                    ...
                    else
                    {
                        client.SendOptionsDialog(Mundane,
                            "It will cost {=c" + client.Aisling.TempItemRepairCost + "{=a Gold to repair everything. Do you Agree?",
                            client.Aisling.TempItemRepairCost.ToString(), optsRepair.ToArray());
                    }
