            ...
            case 0x03:
                {
                    ...
                    client.Aisling.SendAnimationNearby(1, new Position(9, 8));
                    client.CloseDialog();
                    ...
                    {
                        client.Aisling.SendAnimationNearby(50, null, Mundane.Serial);
                    });
                    Task.Delay(350).ContinueWith(ct =>
                    {
                        client.Aisling.SendAnimationNearby(15, new Position(randX1, randY1));
                    });
                    Task.Delay(650).ContinueWith(ct =>
                    {
                        client.Aisling.SendAnimationNearby(15, new Position(randX2, randY2));
                    });
                    Task.Delay(950).ContinueWith(ct =>
                    {
                        client.Aisling.SendAnimationNearby(15, new Position(randX3, randY3));
                    });
                    Task.Delay(1250).ContinueWith(ct =>
                    {
                        client.Aisling.SendAnimationNearby(15, new Position(randX4, randY4));
                    });
                    Task.Delay(1550).ContinueWith(ct =>
                    {
                        client.Aisling.SendAnimationNearby(15, new Position(randX5, randY5));
                    });
                    Task.Delay(1850).ContinueWith(ct =>
                    {
                        client.Aisling.SendAnimationNearby(15, new Position(randX6, randY6));
                    });
                    Task.Delay(1850).ContinueWith(ct =>
                    {
                        client.Aisling.SendAnimationNearby(15, new Position(randX6, randY6));
            ...
            case 0x09:
                {
                    ...
                    {
                        client.Aisling.SendAnimationNearby(63, client.Aisling.Position);
                    });
                    Task.Delay(350).ContinueWith(ct =>
                    {
