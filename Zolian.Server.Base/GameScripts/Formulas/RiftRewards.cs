...
[Script("Rift Rewards")]
public class RiftRewards : RewardScript
{
    private readonly Monster _monster;

    public RiftRewards(Monster monster, Aisling player)
    {
        _monster = monster;
        _ = player;
    }
    ...
    private void GenerateGold()
    {
        ...
        var sum = (uint)Random.Shared.Next(_monster.Template.Level * 500, _monster.Template.Level * 1500);
