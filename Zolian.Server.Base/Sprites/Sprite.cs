...
public abstract class Sprite : INotifyPropertyChanged
{
    ...
    public List<Aisling> AislingsEarShotNearby() => this.AislingsEarShotNearbySnapshot();
    public List<Aisling> AislingsOnMap() => this.AislingsOnMapSnapshot();
    public List<Monster> MonstersNearby() => this.MonstersNearbySnapshot();
